...
class BigQueryField final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR BigQueryField(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BigQuerySchema final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR BigQuerySchema(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const BigQuerySchema& from) {
    BigQuerySchema::MergeImpl(*this, from);
  }
  private:
...
class BigQuerySchemas final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR BigQuerySchemas(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const BigQuerySchemas& from) {
    BigQuerySchemas::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline bool BigQuerySchema::_internal_has_structs_schema() const {
  return this != internal_default_instance() && _impl_.structs_schema_ != nullptr;
}
...
inline const ::structs::StructSchema& BigQuerySchema::_internal_structs_schema() const {
  const ::structs::StructSchema* p = _impl_.structs_schema_;
...
inline void BigQuerySchema::unsafe_arena_set_allocated_structs_schema(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.structs_schema_);
  }
  _impl_.structs_schema_ = structs_schema;
  if (structs_schema) {
...
inline ::structs::StructSchema* BigQuerySchema::release_structs_schema() {
  ...
  ::structs::StructSchema* temp = _impl_.structs_schema_;
...
inline ::structs::StructSchema* BigQuerySchema::_internal_mutable_structs_schema() {
  ...
  if (_impl_.structs_schema_ == nullptr) {
    auto* p = CreateMaybeMessage<::structs::StructSchema>(GetArenaForAllocation());
    _impl_.structs_schema_ = p;
  }
  return _impl_.structs_schema_;
}
...
void BigQuerySchema::set_bigquery_table_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.bigquery_table_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& BigQuerySchema::_internal_bigquery_table_name() const {
  return _impl_.bigquery_table_name_.Get();
}
inline void BigQuerySchema::_internal_set_bigquery_table_name(const std::string& value) {
  
  _impl_.bigquery_table_name_.Set(value, GetArenaForAllocation());
}
inline std::string* BigQuerySchema::_internal_mutable_bigquery_table_name() {
  
  return _impl_.bigquery_table_name_.Mutable(GetArenaForAllocation());
}
inline std::string* BigQuerySchema::release_bigquery_table_name() {
  ...
  return _impl_.bigquery_table_name_.Release();
}
inline void BigQuerySchema::set_allocated_bigquery_table_name(std::string* bigquery_table_name) {
  ...
  _impl_.bigquery_table_name_.SetAllocated(bigquery_table_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.bigquery_table_name_.IsDefault()) {
